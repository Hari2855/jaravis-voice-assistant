    ...
    return (
        <View style={styles.contiainer}>
            <View style={styles.cont2}>
                <Image source={require('../../assests/images/bot.png')} style={styles.img2} />
            </View>
                ...
                messages.length > 0 ? (
                    <View style={{ flex: 1, marginTop: '2%' }}>
                        ...
                        <View style={styles.contiainer3}>
                            <ScrollView bounces={false} showsVerticalScrollIndicator={false} style={{ padding: 5 }} ref={scrollViewRef}>
                                {
            ...
            <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                {
                    loading ? (
                        <Image source={require('../../assests/images/loading.gif')} style={{
                            width: hp(10),
                            height: hp(10),
                        }} />
                        ...
                        recording ? (
                            ...
                            <TouchableOpacity onPress={startRecording}>
                                ...
                                <Image source={require('../../assests/images/recordingIcon.png')} style={styles.img5} />
                            </TouchableOpacity>
                        )
                }
